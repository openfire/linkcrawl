...
config['apptools.project.services'] = {
    ...
    'config': {
        ...
        'secret_key': '__NULL__',  # Secret key for generating HMAC signings
    ...
    'services': {
        ...
        ## Crawl API - for enqueueing URLs to crawl and kicking off crawler jobs
        'crawler': {
			'enabled': True,
			'service': 'project.services.CrawlService',
			'methods': ['add_url', 'start', 'status', 'scraped'],
